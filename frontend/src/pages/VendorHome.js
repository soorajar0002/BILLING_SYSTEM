...
const VendorHome = () => {
  return (
    <div>
      ...
      <Link to="/"><button type="button" class="focus:outline-none text-white bg-black font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:focus:ring-yellow-900 ">LOGOUT</button></Link>
